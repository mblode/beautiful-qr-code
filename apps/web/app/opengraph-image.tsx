...
export const alt = "Beautiful QR Code";
 ...
 * `/beautiful-qr-code/beautiful-qr-code/opengraph-image.png`. A generated
 * route is not prefixed, so this form is the one that cannot double.
 *
